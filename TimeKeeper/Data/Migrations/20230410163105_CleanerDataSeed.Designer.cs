...
namespace TimeKeeper.Data.Migrations
{
    ...
    [Migration("20230410163105_CleanerDataSeed")]
    partial class CleanerDataSeed
    {
            ...
            modelBuilder.Entity("TimeKeeper.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            firstName = "Demo",
                            grade = 5.0,
                            guid = "e1f7213c-473e-4b78-9a52-786852195d25",
                            isAdmin = true,
                            lastName = "Account",
            ...
            modelBuilder.Entity("TimeKeeper.Models.Workday", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            date = new DateTime(2023, 4, 9, 18, 31, 4, 182, DateTimeKind.Local).AddTicks(396),
